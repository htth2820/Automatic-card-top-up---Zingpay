...
#ce	_HttpRequest(2,'https://new.pay.zing.vn/product/gunny')
	For $i=1 To $tach[0]
		If GUICtrlRead($CServer)=$sname[$i-1] Then
			$get_server = _HttpRequest(2, 'https://new.pay.zing.vn/ajax/get-role-list?productCode=gunny&accountName=' & $acc & '&accountID=' & $accountID[0] & '&serverID='&$sc_serverID[$i-1], '', '', 'https://new.pay.zing.vn/product/gunny', 'X-Requested-With: XMLHttpRequest|Upgrade-Insecure-Requests: 1')
