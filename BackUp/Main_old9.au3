...
GUICtrlSetColor(-1, 0x00FF00)
GUICtrlSetBkColor(-1, 0x000000)
GUICtrlSetData(-1, 'Tân Thiên Long|Võ Lâm Truyền Kỳ 1|Võ Lâm Truyền Kỳ 2|Kiếm Thế|Gunny|a|a|a|a|a|a|a|a|a|a|a|a|a|a|a|a|a|a|a|a|a|a|a|a|a|a','Tân Thiên Long')
...
#ce		$name = StringRegExp($login_success, 'class="fr">Xin chào(.*?) <a href=', 1)
