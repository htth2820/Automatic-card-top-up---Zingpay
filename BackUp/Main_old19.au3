...
If @error Then
	MsgBox(64, 'Error', 'Lỗi không xác định!' & @CRLF & 'Vui lòng liên hệ để khắc phục!')
	Exit
EndIf
...
Func _Rec1()
	For $i = 1 To _FileCountLines($file) Step 2
		...
		Else
			...
			_HttpRequest(2, 'https://new.pay.zing.vn/payment/gunny', 'sID=17554&serverID=383&pmOptID=17&pmcID=1&roleID=21675&roleName=Mộng Điệp 351&accountName=lady8288nb1', '', 'https://new.pay.zing.vn/product/gunny', 'Upgrade-Insecure-Requests: 1')
			_HttpRequest(2, 'https://new.pay.zing.vn/ajax/payment-zingcard', 'pmcID=1&pmOptID=17&sID=17554&roleID=21675&roleName=Mộng Điệp 351&productCode=gunny&cardSerial=WG0068128683&cardPassword=JPLDLYM9T&accountName=lady8288nb1', '', 'https://new.pay.zing.vn/payment/gunny', 'X-Requested-With: XMLHttpRequest')
...
Func _LoginGunny()
	...
	Else
		...
		For $i = 1 To $tach[0]
			...
			EndIf
		Next
		$roleID = StringRegExp($cf_server, 'roleID":"(.*?)"', 1)[0]
		$roleName = StringRegExp($cf_server, 'roleName":"(.*?)"', 1)[0]
		_HttpRequest(2, 'https://new.pay.zing.vn/payment/gunny', 'sID='&$sID&'&serverID='&$sc_serverID[$i - 1]&'&pmOptID=17&pmcID=1&roleID='&$roleID&'&roleName='&$roleName&'&accountName='&$acc, '', 'https://new.pay.zing.vn/product/gunny', 'Upgrade-Insecure-Requests: 1')
		_HttpRequest(2, 'https://new.pay.zing.vn/ajax/payment-zingcard', 'pmcID=1&pmOptID=17&sID='&$sID&'&roleID='&$roleID&'&roleName='&$roleName&'&productCode=gunny&cardSerial=WG0068128683&cardPassword=JPLDLYM9T&accountName='&$acc, '', 'https://new.pay.zing.vn/payment/gunny', 'X-Requested-With: XMLHttpRequest')
